...
from vlnce_baselines.common.ddppo_alg import WDDPPO, CWDDPPO, CMADDPPO
from vlnce_baselines.common.env_utils import (
    construct_envs,
    construct_envs_auto_reset_false,
)
from vlnce_baselines.common.rollout_storage import ActionDictRolloutStorage, CMARolloutStorage
...
@baseline_registry.register_trainer(name="ddppo-rl")
class DDPPOCMA(PPOTrainer):
    SHORT_ROLLOUT_THRESHOLD: float = 0.25
